...
from .featurizers import SiteStatsFingerprint  # PartialsSiteStatsFingerprint
from .featurizers import CrystalNNFingerprint
...
class PartialCrystalNNFingerprint(FingerprintValidator):
    ...
    def get_featurizer(
        ...
        **crystalnn_options,
        ...
        featurizer = SiteStatsFingerprint(sitefingerprint_method, stats=stat_options)
