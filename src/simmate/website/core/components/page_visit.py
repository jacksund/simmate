...
class WebsitePageVisitComponent(TableComponent):
    table = WebsitePageVisit
    display_name = "Website Traffic"
    description_short = (
        "Records of page visits across the Simmate website, including "
        "timestamps, URL paths, and user IDs. This data is used to analyze "
        "user engagement and website performance."
    )

    template_names = {
        "entries": "core/website_page_visits/table.html",
    }
