...
@register.inclusion_tag(
    filename="core/basic_elements/alert.html",
    takes_context=True,
)
def alert(
    context: dict,
...
@register.inclusion_tag(
    filename="core/chem_elements/draw_molecule.html",
    takes_context=True,
)
def draw_molecule(
    context: dict,
...
@register.inclusion_tag(
    filename="core/basic_elements/canvas.html",
    takes_context=True,
)
def canvas(
    context: dict,
...
@register.inclusion_tag(
    filename="core/basic_elements/update_entry_link.html",
    takes_context=True,
)
...
@register.inclusion_tag(
    filename="core/basic_elements/status_bar.html",
    takes_context=True,
)
def status_bar(
    context: dict,
