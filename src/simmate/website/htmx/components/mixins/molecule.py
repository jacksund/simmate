...
class MoleculeInput:
    ...
    def load_molecule(self, input_name: str = "molecule"):
        ...
        try:
            ...
            if input_type in ["sketcher", "text"]:
                ...
                if getattr(self, "component_type", None) == "search":
        ...
        if (
            getattr(self, "component_type", None) == "create"
            and self.molecule_match_tables
        ):
    ...
    def load_many_molecules(self, input_name: str = "molecule"):
        ...
        assert getattr(self, "component_type", None) == "create_many"
