    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflow_name', models.CharField(blank=True, max_length=75, null=True)),
                ('workflow_version', models.CharField(blank=True, max_length=75, null=True)),
                ('computer_system', models.CharField(blank=True, max_length=75, null=True)),
                ('directory', models.CharField(blank=True, max_length=250, null=True)),
                ('run_id', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('corrections', models.JSONField(blank=True, null=True)),
                ('chemical_system', models.CharField(blank=True, max_length=10, null=True)),
                ('subworkflow_name', models.CharField(blank=True, max_length=200, null=True)),
                ('subworkflow_kwargs', models.JSONField(blank=True, default=dict, null=True)),
                ('max_atoms', models.IntegerField(blank=True, null=True)),
                ('max_stoich_factor', models.IntegerField(blank=True, null=True)),
                ('singleshot_sources', models.JSONField(blank=True, default=list, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chemical_system', models.CharField(blank=True, max_length=25, null=True)),
                ...
                ('formula_full', models.CharField(blank=True, max_length=50, null=True)),
                ('formula_reduced', models.CharField(blank=True, max_length=50, null=True)),
                ('formula_anonymous', models.CharField(blank=True, max_length=50, null=True)),
                ('started_at', models.DateTimeField(blank=True, null=True)),
                ('finished_at', models.DateTimeField(blank=True, null=True)),
                ('total_time', models.FloatField(blank=True, null=True)),
                ('queue_time', models.FloatField(blank=True, null=True)),
                ...
                ('run_id', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('corrections', models.JSONField(blank=True, null=True)),
                ('migrating_specie', models.CharField(blank=True, max_length=4, null=True)),
                ...
                ('paths_involved', models.CharField(blank=True, max_length=100, null=True)),
                ('npaths_involved', models.IntegerField(blank=True, null=True)),
                ('spacegroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core_components.spacegroup')),
            ],
        ),
        migrations.CreateModel(
            name='Dynamics',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subworkflow_name', models.CharField(blank=True, max_length=200, null=True)),
                ('subworkflow_kwargs', models.JSONField(blank=True, default=dict, null=True)),
                ('fitness_field', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('selector_name', models.CharField(blank=True, max_length=200, null=True)),
                ('selector_kwargs', models.JSONField(blank=True, default=dict, null=True)),
                ('validator_name', models.CharField(blank=True, max_length=200, null=True)),
                ('validator_kwargs', models.JSONField(blank=True, default=dict, null=True)),
                ('singleshot_sources', models.JSONField(blank=True, default=list, null=True)),
                ('sleep_step', models.FloatField(blank=True, null=True)),
                ('unique_individuals_ids', models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diffusion_analysis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='migration_hops', to='workflows.diffusionanalysis')),
            ],
        ),
        migrations.CreateModel(
            name='StaticEnergy',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('staticenergy_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='workflows.staticenergy')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steadystate_sources', to='workflows.fixedcompositionsearch')),
            ],
        ),
        migrations.CreateModel(
            name='Relaxation',
            fields=[
                ...
                ('spacegroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core_components.spacegroup')),
                ('structure_final', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='relaxations_as_final', to='workflows.ionicstep')),
            ],
        ),
        migrations.CreateModel(
            name='MigrationImage',
            fields=[
                ...
                ('migration_hop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='migration_images', to='workflows.migrationhop')),
                ('spacegroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core_components.spacegroup')),
            ],
        ),
        migrations.AddField(
            ...
            name='relaxation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='structures', to='workflows.relaxation'),
        ),
        migrations.AddField(
            model_name='ionicstep',
            name='spacegroup',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core_components.spacegroup'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dynamics_run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='structures', to='workflows.dynamics')),
                ('spacegroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core_components.spacegroup')),
            ],
        ),
        migrations.CreateModel(
