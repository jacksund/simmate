...
Below is an example of a simple VaspTask and then an advanced one. Note only the
advanced one is used in our workflows.
"""
...
class SimpleRelaxationTask(VaspTask):
