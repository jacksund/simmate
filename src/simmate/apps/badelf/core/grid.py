...
class Grid:
    ...
    def from_file(cls, grid_file: str | Path):
        ...
        total = np.fromstring(
            total_str, 
            sep=" ",
        ).ravel().reshape(grid_shape, order="F")
    ...
    def regrid(self, 
        ...
        new_total_pgrid = total_pgrid.get_transformed([[1,0,0],[0,1,0],[0,0,1]], new_grid_shape)
        ...
        if diff is not None:
            ...
            new_diff_pgrid = diff_pgrid.get_transformed([[1,0,0],[0,1,0],[0,0,1]], new_grid_shape)
    ...
    def get_voxel_coords_from_index(self, site):
        ...
        voxel_coords = [a * b + 1 for a, b in zip(self.grid_shape, self.frac_coords[site])]
