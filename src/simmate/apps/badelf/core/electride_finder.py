...
class ElectrideFinder:
    ...
    def to_number_from_roman_numeral(roman_num):
        ...
        while i < len(roman_num):
            ...
            if i + 1 < len(roman_num) and lookup[roman_num[i]] < lookup[roman_num[i + 1]]:
    ...
    def shannon_radii_estimate(self):
        ...
        for site_index, site in enumerate(structure):
            ...
            # key value.
            closest_ox_state = min(available_ox_state, key=lambda x: abs(int(x)-oxidation_state))
            ...
            shannon_radius = species_dict[closest_ox_state][closest_coord_env]['']['crystal_radius']
    ...
    def get_electride_structure(
        ...
        min_electride_radius: float = 1.19,
        ...
        for i, maximum_coords in enumerate(local_maxima_coords):
            ...
            for neighbor in electride_neighbors:
                ...
                if neighbor["site"].species_string != "He":
                    distance_to_atom = math.dist(maximum_coords, neighbor["site"].coords)
