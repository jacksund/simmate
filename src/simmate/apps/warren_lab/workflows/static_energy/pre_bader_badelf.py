...
class StaticEnergy__Vasp__PreFinderWarren(StaticEnergy__Vasp__PbesolWarren):
    """
    Runs a static energy calculation with a low-density FFT grid to quickly scan
    for electride features.
    ...
    # than that, it's the same as a static energy calculation.
    _incar_updates = dict(
        NGX__density_a=10,  # set grid and fine grid to same, reasonably accurate value
        NGY__density_b=10,
        NGZ__density_c=10,
        NGXF__density_a=10,
        NGYF__density_b=10,
