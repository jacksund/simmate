...
class Relaxation__Vasp__SpinPbeMetalWarren(Relaxation__Vasp__SpinPbeWarren):
    """
    Runs a spin-polarized VASP relaxation calculation using Warren Lab PBE functional settings
    with some adjusted settings to accomodate metals.
    """
