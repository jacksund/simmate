...
class Relaxation__Vasp__ScanWarren(Relaxation__Vasp__PbeWarren):
    """
...
class Relaxation__Vasp__SpinScanWarren(Relaxation__Vasp__SpinPbeWarren):
    """
    Runs a spin-polarized VASP relaxation calculation using Warren Lab SCAN functional settings.
    """
