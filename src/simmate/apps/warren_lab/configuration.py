...
from simmate.apps.badelf.configuration import test_config as test_badelf_config
...
def test_config(run_calcs: bool = False):
    ...
    passed_all = bool(is_registered and has_bader and has_vasp and has_badelf)
