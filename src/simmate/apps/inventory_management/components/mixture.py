...
class MixtureComponent(TableComponent):
    table = Mixture
    ...
    template_names = {
        ...
        "search": "inventory_management/mixture/form.html",
        "create": "inventory_management/mixture/form.html",
        "update": "inventory_management/mixture/form.html",
    }
