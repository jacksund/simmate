...
class ContainerComponent(TableComponent):
    ...
    template_names = {
        ...
        "search": "inventory_management/container/form.html",
        "create": "inventory_management/container/form.html",
        "update": "inventory_management/container/form.html",
    }
