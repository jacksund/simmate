...
class PopulationAnalysis__Vasp__ElfMatprojPbesol(StaticEnergy__Vasp__MatprojPbesol):
    """
    Runs a static energy calculation under settings from the Materials Project
    using the PBEsol functional and also writes the electron localization function
    (to ELFCAR).
    """
