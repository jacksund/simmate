...
class PopulationAnalysis__VaspBader__BadelfMatprojPbesol(Workflow):
    """
    ...
    def run_config(
        ...
        **kwargs,
        ...
        prebadelf_result = StaticEnergy__Vasp__PrebadelfMatprojPbesol.run(
            structure=structure,
            command=command,
            source=source,
            directory=directory,
...
class StaticEnergy__Vasp__PrebadelfMatprojPbesol(StaticEnergy__Vasp__MatprojPbesol):
    """
