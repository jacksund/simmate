...
class PopulationAnalysis__VaspBader__BadelfMatprojHsesol(Workflow):
    """
    ...
    def run_config(
        ...
        **kwargs,
        ...
        prebadelf_result = StaticEnergy__Vasp__PrebadelfMatprojHsesol.run(
            structure=structure,
            command=command,
            source=source,
            directory=directory,
...
class StaticEnergy__Vasp__PrebadelfMatprojHsesol(StaticEnergy__Vasp__MatprojHsesol):
    """
