...
class PopulationAnalysis__VaspBader__BadelfMatprojScan(Workflow):
    """
    ...
    def run_config(
        ...
        **kwargs,
        ...
        prebadelf_result = StaticEnergy__Vasp__PrebadelfMatprojScan.run(
            structure=structure,
            command=command,
            source=source,
            directory=directory,
...
class StaticEnergy__Vasp__PrebadelfMatprojScan(StaticEnergy__Vasp__MatprojScan):
    """
