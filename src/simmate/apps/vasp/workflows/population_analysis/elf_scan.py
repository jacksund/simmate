...
class PopulationAnalysis__Vasp__ElfMatprojScan(StaticEnergy__Vasp__MatprojScan):
    """
    Runs a static energy calculation under settings from the Materials Project
    using the SCAN functional and also writes the electron localization function
    (to ELFCAR).
    """
