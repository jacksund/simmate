...
class PopulationAnalysis__Vasp__ElfMatprojHsesol(StaticEnergy__Vasp__MatprojHsesol):
    """
    Runs a static energy calculation under settings from the Materials Project
    using the HSEsol functional and also writes the electron localization function
    (to ELFCAR).
    """
