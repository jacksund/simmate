...
class PopulationAnalysis__Vasp__ElfMatprojHse(StaticEnergy__Vasp__MatprojHse):
    """
    Runs a static energy calculation under settings from the Materials Project
    using the HSE functional and also writes the electron localization function
    (to ELFCAR).
    """
