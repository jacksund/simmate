...
class PopulationAnalysis__VaspBader__BadelfMatprojHse(Workflow):
    """
    ...
    def run_config(
        ...
        **kwargs,
        ...
        prebadelf_result = StaticEnergy__Vasp__PrebadelfMatprojHse.run(
            structure=structure,
            command=command,
            source=source,
            directory=directory,
...
class StaticEnergy__Vasp__PrebadelfMatprojHse(StaticEnergy__Vasp__MatprojHse):
    """
