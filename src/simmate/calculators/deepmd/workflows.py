...
class Create__Deepmd__Model(Workflow):
    ...
    def run_config(structure, directory, **kwargs):
       ...
       #define subdirectory to run relaxation in 
        ...
        state = relax_workflow.run(structure=structure, directory=relax_subdirectory)
        ...
        for x in temp_list:
            ...
            state = md_workflow.run_cloud(structure = relax_result,
                                          temperature_start = x,
                                          temperature_end = x,
                                          nsteps = 50) 
        ...
        Run__Deepmd__Training.run(structure = structure,
        ...
        Run__Deepmd__Training.run(structure = relax_result.structure, 
