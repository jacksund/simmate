...
class Kpoints:
    ...
    @staticmethod
    def write_file(
        # structure to base off of. this will be passed through the kpt_method
        structure,
        ...
        # just use "Generated by Simmate with [name of kpt_method]"
        if not comment:
            comment = f"Generated by Simmate at {str(kpt_method)} kpts per Ang^-1"
        lines.append(comment)

        # check to see if kpt_method is a KptGrid object
        ...
        # ready for it.
        if isinstance(kpt_method, float):
            ...
            for vector in structure.lattice.reciprocal_lattice.abc:
                ...
                # TODO - reciprocal_density = kpt_method until I add KptGrid class
                nsubdivisions = math.ceil(vector / kpt_method)
            ...
            # if kpt_method.shift:
            #     lines.append(kpt_method.shift)

        # TODO - I haven't written the KptPath object yet so I can't do this.
        # chek to see if kpt_method is a KptPath object
        # elif isinstance(kpt_method, KptPath):
        #     pass
