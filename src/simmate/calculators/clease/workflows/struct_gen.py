...
class ClusterExpansion__Python__StructureGen(Workflow):
    ...
    def run_config(
        ...
        **kwargs
        ...
        )  # specifies the number of structures you want and the generation number for organization
        ...
        for row in db.select(
            ...
            atms = row.toatoms()
            atms.write(
                "structure_%s.cif" % row.id, format="cif"
            )  # creates cif files of each structure and names them based on their row id number
