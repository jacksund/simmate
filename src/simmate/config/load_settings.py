        ...
        return {
            ...
            "website": {
                ...
                "data": {
                    ...
                    "Workflow Results": [
                        "simmate.website.workflow_explorer.components.StaticEnergyTable",
                        "simmate.website.workflow_explorer.components.RelaxationTable",
                        "simmate.website.workflow_explorer.components.PopulationAnalysisTable",
                        "simmate.website.workflow_explorer.components.DensityofStatesCalcTable",
                        "simmate.website.workflow_explorer.components.BandStructureCalcTable",
                        "simmate.website.workflow_explorer.components.DiffusionAnalysisTable",
                        "simmate.website.workflow_explorer.components.DynamicsTable",
                    ...
                    "HIDDEN": [
                        ...
                        "simmate.website.workflow_explorer.components.IonicStepTable",
                        "simmate.website.workflow_explorer.components.MigrationHopTable",
                        "simmate.website.workflow_explorer.components.MigrationImageTable",
                        "simmate.website.workflow_explorer.components.DynamicsIonicStepTable",
                    ],
                },
                # django extras
                "log_sql": False,
