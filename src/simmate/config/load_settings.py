    ...
    def default_settings(self) -> dict:
        ...
        return {
            ...
            "apps": [
                ...
                "simmate.apps.configs.PpdbConfig",
            ...
            "website": {
                ...
                "data": {
                    "Project Management": [
                        "simmate.apps.project_management.components.ProjectForm",
                        "simmate.apps.project_management.components.TagForm",
                        "simmate.apps.project_management.components.WalletForm",
                        "simmate.apps.project_management.components.TransactionForm",
                    ],
                    "Inventory Management": [
                        "simmate.apps.inventory_management.components.SubstanceForm",
                        "simmate.apps.inventory_management.components.MixtureForm",
                        "simmate.apps.inventory_management.components.BatchForm",
                        "simmate.apps.inventory_management.components.ContainerForm",
                        "simmate.apps.inventory_management.components.UsageLogForm",
                        "simmate.apps.inventory_management.components.StorageLocationForm",
                    ],
                    "Crystalline Catalogs": [
                        "simmate.apps.aflow.components.AflowPrototypeTable",
                        "simmate.apps.aflow.components.AflowStructureTable",
                        "simmate.apps.cod.components.CodStructureTable",
                        "simmate.apps.jarvis.components.JarvisStructureTable",
                        "simmate.apps.materials_project.components.MatprojStructureTable",
                        "simmate.apps.oqmd.components.OqmdStructureTable",
                    ],
                    "Molecular Catalogs": [
                        "simmate.apps.bcpc.components.BcpcIsoPesticideTable",
                        "simmate.apps.cas_registry.components.CasRegistryMoleculeTable",
                        "simmate.apps.chembl.components.ChemblMoleculeTable",
                        "simmate.apps.chemspace.components.ChemSpaceFreedomSpaceMoleculeTable",
                        "simmate.apps.emolecules.components.EmoleculesMoleculeTable",
                        "simmate.apps.enamine.components.EnamineRealMoleculeTable",
                        "simmate.apps.pdb.components.PdbLigandTable",
                        "simmate.apps.ppdb.components.PpdbMoleculeTable",
                    ],
                    "Workflow Results": [
                        "simmate.website.htmx.components.workflow_results.StaticEnergyTable",
                        "simmate.website.htmx.components.workflow_results.RelaxationTable",
                        "simmate.website.htmx.components.workflow_results.PopulationAnalysisTable",
                        "simmate.website.htmx.components.workflow_results.DensityofStatesCalcTable",
                        "simmate.website.htmx.components.workflow_results.BandStructureCalcTable",
                        "simmate.website.htmx.components.workflow_results.DiffusionAnalysisTable",
                        "simmate.website.htmx.components.workflow_results.DynamicsTable",
                    ...
                    "HIDDEN": [
                        ...
                        "simmate.apps.evolution.components.SteadystateSourceTable",
                        "simmate.apps.price_catalog.components.PricePointTable",
                        "simmate.website.htmx.components.workflow_results.IonicStepTable",
                        "simmate.website.htmx.components.workflow_results.MigrationHopTable",
                        "simmate.website.htmx.components.workflow_results.MigrationImageTable",
                        "simmate.website.htmx.components.workflow_results.DynamicsIonicStepTable",
                    ],
                },
                # django extras
                "log_sql": False,
