...
def test_list_of_all_workflows():
    ...
    assert get_all_workflow_names() == [
        ...
        "population-analysis.vasp-bader.badelf-matproj-hse",
        "population-analysis.vasp-bader.badelf-matproj-hsesol",
        "population-analysis.vasp-bader.badelf-matproj-pbesol",
        "population-analysis.vasp-bader.badelf-matproj-scan",
        "population-analysis.vasp-bader.bader-matproj",
        "population-analysis.vasp-bader.bader-matproj-hse",
        "population-analysis.vasp-bader.bader-matproj-hsesol",
        "population-analysis.vasp-bader.bader-matproj-pbesol",
        "population-analysis.vasp-bader.bader-matproj-scan",
        "population-analysis.vasp.elf-matproj",
        "population-analysis.vasp.elf-matproj-hse",
        "population-analysis.vasp.elf-matproj-hsesol",
        "population-analysis.vasp.elf-matproj-pbesol",
        "population-analysis.vasp.elf-matproj-scan",
        ...
        "static-energy.vasp.prebadelf-matproj-hse",
        "static-energy.vasp.prebadelf-matproj-hsesol",
        "static-energy.vasp.prebadelf-matproj-pbesol",
        "static-energy.vasp.prebadelf-matproj-scan",
        "static-energy.vasp.prebader-matproj",
        "static-energy.vasp.prebader-matproj-hse",
        "static-energy.vasp.prebader-matproj-hsesol",
        "static-energy.vasp.prebader-matproj-pbesol",
        "static-energy.vasp.prebader-matproj-scan",
