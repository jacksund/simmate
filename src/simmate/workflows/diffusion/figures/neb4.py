...
#     "structure__e_above_hull",
#     "empiricalmeasures__ewald_energy",
#     "vaspcalcd__energy_barrier_initial",
# ]
...
# # Add axes for the main plot
# ax = fig.add_subplot(
#     xlabel=r"IDPP-relaxed Barrier (eV) [NSW=0]",
#     ylabel=r"Midpoint-only NEB Barrier (eV)",
#     # xlim=(-0.5, 2.5),
#     # ylim=(-0.5, 2.5),
# )
...
# # add the data as a scatter
# hb = ax.scatter(
#     x=df["vaspcalcd__energy_barrier_initial"],  # X
#     y=df["vaspcalcb__energy_barrier"],  # Y
#     c="Green",  # COLOR
#     alpha=0.6,  # Transparency
# )
...
# # add the data as a scatter
# hb = ax.scatter(
#     x=df["vaspcalcd__energy_barrier"],  # X
#     y=df["vaspcalcb__energy_barrier"],  # Y
#     c="Blue",  # COLOR
#     alpha=0.6,  # Transparency
# )
...
# df["ci_b"] = df["vaspcalcd__energy_barrier_initial"] - df["vaspcalcb__energy_barrier"]
# df["cie_b"] = y_test_predicted - df["vaspcalcb__energy_barrier"]
# df["c_b"] = df["vaspcalcd__energy_barrier"] - df["vaspcalcb__energy_barrier"]
