...
class LoadInputAndRegister(Task):
    ...
    def run(
        ...
        if use_previous_directory and structure_cleaned.is_from_past_calc:
            ...
            directory_cleaned = structure_cleaned.calculation.directory

        # catch incorrect use of this function
        elif use_previous_directory and not structure_cleaned.is_from_past_calc:
            raise Exception(
        ...
        if source and structure_cleaned.is_from_past_calc:
            # note structure here is a dictionary input
            assert source == structure
        elif structure_cleaned.is_from_past_calc:
