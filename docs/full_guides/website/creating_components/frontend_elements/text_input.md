...
| `placeholder`     | The placeholder text to display when input field is empty.<br><small>*Type: `str`, Default: `"Enter value..."`*</small>                                           |
...
| `dynamically_set` | Whether the input is dynamically set by other components.<br><small>*Type: `bool`, Default: `False`*</small>                                                     |
